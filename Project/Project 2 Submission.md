...
* Stress
    ...
    <img src="/Project/img/math_pressure.PNG" alt="math" style="height: 80px;"/> 
...
* Natural Frequency
    ...
    <img src="/Project/img/math_nat_freq.PNG" alt="math" style="height: 80px;"/> 
...
* Temperature
    ...
    <img src="/Project/img/math_therm_mass.PNG" alt="math" style="height: 80px;"/> 
...
<img src="/Project/img/ansys_structure.PNG" alt="structure" style="height: 600px;"/> 
...
<img src="/Project/img/brake_side_comp.PNG" alt="side_comparison" style="height: 600px;"/> 

### Sensitivity Analysis

A quick sensitity chart generated by ANSYS is shown below for comparing thickness to the output parameters. We see strong correlations with thickness and stress as well as natural frequency as expected.

<img src="/Project/img/brake_sensitivity.PNG" alt="thickness_sensitivity" style="height: 600px;"/> 
